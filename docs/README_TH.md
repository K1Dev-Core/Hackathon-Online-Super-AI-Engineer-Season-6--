...
| `SuperAI6_IoT_Attack_Detection_Offline02_Concept_and_Human_Speech_TH.md` | อธิบายแนวคิดและซ้อมพูด | แนวคิดการทำงานจริงทีละสไลด์ พร้อมประโยคพูดแบบภาษาคนและ script พูดต่อเนื่อง 3 นาที |
| `SuperAI6_IoT_Attack_Detection_Offline02_Methodology_AI_Assisted_TH.md` | อธิบายวิธีทำและการใช้ AI | methodology ครบตั้งแต่ข้อมูล, Normal profile, protocol rules, context, hard negative, AI-assisted development, validation และผลลัพธ์ |
